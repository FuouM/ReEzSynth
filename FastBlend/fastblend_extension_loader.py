# ezsynth/fastblend/fastblend_extension_loader.py
...
_ext_dir = Path(__file__).parent / "fastblend_extension"

# List all the source files for the extension
_source_files = [
    _ext_dir / "extension.cpp",
...
try:
    ...
    fastblend_extension = torch.utils.cpp_extension.load(
        name=MODULE_NAME,
