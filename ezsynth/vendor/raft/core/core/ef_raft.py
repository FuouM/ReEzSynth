...
from .extractor import BasicEncoder, CoordinateAttention, SmallEncoder
from .update import BasicUpdateBlock, LookupScaler, SmallUpdateBlock
    ...
    def __init__(self, args):
        ...
        if args.small:
            ...
            self.lookup_scaler = LookupScaler(
                input_dim=hdim,
                output_size=args.corr_levels,  # New
            )
